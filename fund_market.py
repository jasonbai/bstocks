...
def fund_analysis():
    ...
    if choose == '公募基金排行':
       ...
       '近6月', '近1年', '近2年', '近3年', '今年来', '成立来', '手续费']]
        ...
        myfund_list = ["040046","164701","007721","007380","006282","160416","162411","015016","519191","008763","013308","000043","000893","001668","000369","006105","016630","006105","016630","005613","164824","206011"]
        stock_market = StockMarket_fund()
        df_fund = stock_market.my_fund_list()
